[![Run App BachNguyen](https://github.com/vBach02/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/vBach02/GithubActions/actions/workflows/run-app.yaml)
